...
/* Archived builtin themes — pulled out of the active set during the theme
   rework so the app ships only Quartz. Code is kept verbatim so these can be
   ported back later: spread ARCHIVED_THEMES back into BUILTIN_THEMES (and add
   their THEME_BEHAVIORS / THEME_DESCRIPTIONS entries) to restore them.
   Not imported anywhere at runtime. */
export const ARCHIVED_THEMES: Theme[] = [
    {

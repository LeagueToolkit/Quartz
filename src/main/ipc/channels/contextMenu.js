function registerContextMenuChannels({
  ...
  const doEnableContextMenu = async () => {
    ...
    const cleanupRoots = [
      ...
      'HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz',
      'HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz',
      'HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz',
      'HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz',
    ...
    const commands = [
      ...
      // --- VFX group (separator above Separate VFX) ---
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\10separatevfx" /v "MUIVerb" /d "Separate VFX" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\10separatevfx" /v "CommandFlags" /t REG_DWORD /d 0x20 /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\10separatevfx" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\10separatevfx\\command" /ve /d "\\"${quartzExe}\\" separate-vfx \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\11combinevfx" /v "MUIVerb" /d "Combine VFX" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\11combinevfx" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\11combinevfx\\command" /ve /d "\\"${quartzExe}\\" combine-vfx \\"%1\\"" /f`,
      // --- Animations group (separator above Separate Animations) ---
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\20separateanm" /v "MUIVerb" /d "Separate Animations" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\20separateanm" /v "CommandFlags" /t REG_DWORD /d 0x20 /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\20separateanm" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\20separateanm\\command" /ve /d "\\"${quartzExe}\\" separate-anm \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\21combineanm" /v "MUIVerb" /d "Combine Animations" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\21combineanm" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\21combineanm\\command" /ve /d "\\"${quartzExe}\\" combine-anm \\"%1\\"" /f`,
      // --- General tools (separator above Combine Linked) ---
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\30combinelinked" /v "MUIVerb" /d "Combine Linked" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\30combinelinked" /v "CommandFlags" /t REG_DWORD /d 0x20 /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\30combinelinked" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\30combinelinked\\command" /ve /d "\\"${quartzExe}\\" combine-linked \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\31noskinlite" /v "MUIVerb" /d "NoSkinLite" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\31noskinlite" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\31noskinlite\\command" /ve /d "\\"${quartzExe}\\" noskinlite \\"%1\\"" /f`,
      ...
      // XPS to FBX for .mesh/.xps/.ascii
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz" /v "MUIVerb" /d "Quartz" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz" /v "SubCommands" /d "" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz\\shell\\01xps2fbx" /v "MUIVerb" /d "Convert XPS to .fbx" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz\\shell\\01xps2fbx" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz\\shell\\01xps2fbx\\command" /ve /d "\\"${quartzExe}\\" xps2fbx \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz\\shell\\02xps2fbxdir" /v "MUIVerb" /d "Batch: Convert all XPS in this folder" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz\\shell\\02xps2fbxdir" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz\\shell\\02xps2fbxdir\\command" /ve /d "\\"${quartzExe}\\" xps2fbxdir \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz" /v "MUIVerb" /d "Quartz" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz" /v "SubCommands" /d "" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz\\shell\\01xps2fbx" /v "MUIVerb" /d "Convert XPS to .fbx" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz\\shell\\01xps2fbx" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz\\shell\\01xps2fbx\\command" /ve /d "\\"${quartzExe}\\" xps2fbx \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz\\shell\\02xps2fbxdir" /v "MUIVerb" /d "Batch: Convert all XPS in this folder" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz\\shell\\02xps2fbxdir" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz\\shell\\02xps2fbxdir\\command" /ve /d "\\"${quartzExe}\\" xps2fbxdir \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz" /v "MUIVerb" /d "Quartz" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz" /v "SubCommands" /d "" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz\\shell\\01xps2fbx" /v "MUIVerb" /d "Convert XPS to .fbx" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz\\shell\\01xps2fbx" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz\\shell\\01xps2fbx\\command" /ve /d "\\"${quartzExe}\\" xps2fbx \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz\\shell\\02xps2fbxdir" /v "MUIVerb" /d "Batch: Convert all XPS in this folder" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz\\shell\\02xps2fbxdir" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz\\shell\\02xps2fbxdir\\command" /ve /d "\\"${quartzExe}\\" xps2fbxdir \\"%1\\"" /f`,
      // PMX to FBX for .pmx
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz" /v "MUIVerb" /d "Quartz" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz" /v "SubCommands" /d "" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz\\shell\\01pmx2fbx" /v "MUIVerb" /d "Convert PMX to .fbx" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz\\shell\\01pmx2fbx" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz\\shell\\01pmx2fbx\\command" /ve /d "\\"${quartzExe}\\" pmx2fbx \\"%1\\"" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz\\shell\\02pmx2fbxdir" /v "MUIVerb" /d "Batch: Convert all PMX in this folder" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz\\shell\\02pmx2fbxdir" /v "Icon" /d "${iconPath}" /f`,
      `reg add "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz\\shell\\02pmx2fbxdir\\command" /ve /d "\\"${quartzExe}\\" pmx2fbxdir \\"%1\\"" /f`,
    ...
    try {
      ...
      try {
        const checks = [
          ...
          { query: 'reg query "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\10separatevfx\\command" /ve', expected: quartzExe },
          { query: 'reg query "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\11combinevfx\\command" /ve', expected: quartzExe },
          { query: 'reg query "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\20separateanm\\command" /ve', expected: quartzExe },
          { query: 'reg query "HKCU\\Software\\Classes\\SystemFileAssociations\\.bin\\shell\\Quartz\\shell\\21combineanm\\command" /ve', expected: quartzExe },
  ...
  ipcMain.handle('contextMenu:disable', async () => {
    ...
    try {
      ...
      const commands = [
        ...
        'reg delete "HKCU\\Software\\Classes\\SystemFileAssociations\\.mesh\\shell\\Quartz" /f',
        'reg delete "HKCU\\Software\\Classes\\SystemFileAssociations\\.xps\\shell\\Quartz" /f',
        'reg delete "HKCU\\Software\\Classes\\SystemFileAssociations\\.ascii\\shell\\Quartz" /f',
        'reg delete "HKCU\\Software\\Classes\\SystemFileAssociations\\.pmx\\shell\\Quartz" /f',

...
const SystemActionsButton = React.memo(
    ({
        ...
        const menuItemSx = (isDestructive = false) => ({
            ...
            '&:hover': {
                background: isDestructive ? 'rgba(239,68,68,0.16)' : 'color-mix(in srgb, var(--accent2), transparent 88%)',
                color: isDestructive ? '#ff8f8f' : 'var(--accent2)',
            },
            '&.Mui-disabled': { opacity: 0.35, cursor: 'not-allowed' },
            '& .MuiSvgIcon-root': { fontSize: 16, color: isDestructive ? '#ff7a7a' : 'var(--accent2)' },
            ...
            <>
                <IconButton
                    ...
                    sx={{
                        ...
                        background: isOpen ? 'color-mix(in srgb, var(--accent2), transparent 72%)' : 'color-mix(in srgb, var(--accent2), transparent 90%)',

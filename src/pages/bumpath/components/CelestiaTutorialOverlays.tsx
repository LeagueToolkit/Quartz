...
interface CelestiaTutorialOverlaysProps {
    showCelestiaGuide: boolean;
    celestiaStepIndex: number;
    binListHighlightRect: SpotlightRect | null;
    panelStyle: SxProps<Theme>;
    simulatedBinSelected: boolean;
    setSimulatedBinSelected: (value: boolean) => void;
}

...
const modalStyles: Record<string, React.CSSProperties> = {
    ...
    // padding). Use vh (not %) so the cap holds even though the overlay height is
    // auto in the flex context; otherwise a full list overflows and the centered
    // modal clips at the top.
    modal: { position: 'relative', width: '100%', maxWidth: 860, height: 'auto', minHeight: 'min(560px, calc(100vh - 48px))', maxHeight: 'min(720px, calc(100vh - 48px))', display: 'flex', flexDirection: 'column', background: 'var(--bg-secondary)', border: '1px solid var(--border)', borderRadius: 16, boxShadow: 'var(--dl-shadow-lg)', overflow: 'hidden' },
                ...
                <div style={modalStyles.overlay}>
                    ...
                    <div style={modalStyles.modal} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div style={modalStyles.body}>
                            ...
                            <div style={{ ...modalStyles.section, marginBottom: 0, padding: 0, overflow: 'hidden', flex: '1 1 0', minHeight: 0, display: 'flex', flexDirection: 'column' }}>

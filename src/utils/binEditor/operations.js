...
/**
 * Set miscRenderFlags to a specific value
 * @param {Object} data - Parsed data
 * @param {Set<string>} selectedKeys - Selected emitter keys
 * @param {number} value - New value
 * @returns {{modified: number, errors: string[]}}
 */
export function setMiscRenderFlags(data, selectedKeys, value) {
    let modified = 0;
    const errors = [];
...
/**
 * Add miscRenderFlags to selected emitters that don't have it
 * @param {Object} data - Parsed data
 * @param {Set<string>} selectedKeys - Selected emitter keys
 * @param {number} value - Initial value (default 1)
 * @returns {{added: number, errors: string[]}}
 */
export function addMiscRenderFlags(data, selectedKeys, value = 1) {
    let added = 0;
    const errors = [];

...
/**
 * Update miscRenderFlags (u8)
 * @param {Object} emitter - Emitter object
 * @param {number} newValue - New value
 * @returns {boolean} Success
 */
export function updateMiscRenderFlags(emitter, newValue) {
...
/**
 * Insert miscRenderFlags: u8 = 1 into an emitter
 * @param {Object} emitter - Emitter object
 * @param {number} value - Initial value (default 1)
 * @returns {boolean} Success
 */
export function insertMiscRenderFlags(emitter, value = 1) {
    if (emitter.miscRenderFlags !== undefined && emitter.miscRenderFlags !== null) return false;
    ...
    // Build the miscRenderFlags line

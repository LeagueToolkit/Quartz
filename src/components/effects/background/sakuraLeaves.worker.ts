...
let driftX: Float32Array | null = null;
let swayAmp: Float32Array | null = null;
let swayFreq: Float32Array | null = null;
let swayPhase: Float32Array | null = null;
let rotation: Float32Array | null = null;
let rotationSpeed: Float32Array | null = null;
let alpha: Float32Array | null = null;
let colorIndex: Uint8Array | null = null;
...
const particleCountForSize = (w: number, h: number) => Math.max(16, Math.floor((w * h) / 120000));
...
const initPetal = (i: number, startAbove: boolean) => {

...
let starX: Float32Array | null = null; // base left % positions
let starY: Float32Array | null = null; // base top % positions
let starSize: Float32Array | null = null;
let starDepth: Float32Array | null = null;
let starPhase: Float32Array | null = null; // twinkle phase
let starSpeed: Float32Array | null = null; // twinkle speed
let count = 0;
...
let starSprite: OffscreenCanvas | null = null;
...
function resetIdleTimer() {
  ...
  idleTimer = self.setTimeout(() => stopLoop(), 2000);
}

...
let len: Float32Array | null = null;
let speed: Float32Array | null = null;
let wind: Float32Array | null = null;
...
const dropCountForSize = (w: number, h: number) => Math.max(80, Math.floor((w * h) / 12000));

const initDrop = (i: number, fromTop: boolean) => {

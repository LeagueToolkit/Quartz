...
let driftVelocity: Float32Array | null = null;
let driftTurnRate: Float32Array | null = null;
let driftMax: Float32Array | null = null;
let driftFrequency: Float32Array | null = null;
let driftPhase: Float32Array | null = null;
...
const bubbleCountForSize = (w: number, h: number) => Math.max(12, Math.floor((w * h) / 100000));
...
const drawBubble = (i: number, _tick: number) => {

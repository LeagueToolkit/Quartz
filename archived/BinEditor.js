    ...
    <Box
      sx={{
        ...
        background: isAllSelected
          ? 'color-mix(in srgb, var(--accent2), var(--bg) 90%)'
          : 'transparent',
        border: 'none',
      ...
      >
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1 }}>
            ...
            <button
              ...
              style={{
                padding: '0.5rem 0.75rem',
                background: (!isUndoAvailable || isLoading) ? 'rgba(160,160,160,0.1)' : 'color-mix(in srgb, var(--accent2), var(--bg) 85%)',
                border: (!isUndoAvailable || isLoading) ? '1px solid rgba(200,200,200,0.1)' : '1px solid color-mix(in srgb, var(--accent2), transparent 70%)',
            ...
            <button
              ...
              style={{
                padding: '0.5rem 0.75rem',
                background: (!hasUnsavedChanges || isLoading) ? 'rgba(160,160,160,0.1)' : 'color-mix(in srgb, var(--accent), var(--bg) 85%)',
                border: (!hasUnsavedChanges || isLoading) ? '1px solid rgba(200,200,200,0.1)' : '1px solid rgba(236,185,106,0.3)',
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
          ...
          <button
            ...
            style={{
              padding: '0.5rem 0.75rem',
              background: (!binData || isLoading || selectedMode === 'bindWeight' || selectedMode === 'translationOverride') ? 'rgba(160,160,160,0.1)' : 'color-mix(in srgb, var(--accent), var(--bg) 85%)',
              border: (!binData || isLoading || selectedMode === 'bindWeight' || selectedMode === 'translationOverride') ? '1px solid rgba(200,200,200,0.1)' : '1px solid rgba(236,185,106,0.32)',
        ...
        {modeSettings.bindWeight && (
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap', mt: 2 }}>
            ...
            <button
              ...
              style={{
                padding: '0.5rem 0.75rem',
                background: (!binData || isLoading) ? 'rgba(160,160,160,0.1)' : 'color-mix(in srgb, var(--accent2), var(--bg) 85%)',
                border: (!binData || isLoading) ? '1px solid rgba(200,200,200,0.1)' : '1px solid color-mix(in srgb, var(--accent2), transparent 70%)',
            ...
            <button
              ...
              style={{
                padding: '0.5rem 0.75rem',
                background: (!binData || isLoading) ? 'rgba(160,160,160,0.1)' : 'color-mix(in srgb, var(--accent), var(--bg) 85%)',
                border: (!binData || isLoading) ? '1px solid rgba(200,200,200,0.1)' : '1px solid rgba(236,185,106,0.32)',
